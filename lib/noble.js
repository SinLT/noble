...
Noble.prototype.cancelLeConn = function() {
  this._bindings.cancelLeConn();
};
...
Noble.prototype.onServicesDiscover = function(peripheralUuid, serviceUuids) {
  ...
  if (peripheral) {
    ...
    for (var i = 0; i < serviceUuids.length; i++) {
      ...
      if (typeof this._characteristics[peripheralUuid][serviceUuid] !== 'object') {
        this._characteristics[peripheralUuid][serviceUuid] = {};
      }
      if (typeof this._descriptors[peripheralUuid][serviceUuid] !== 'object') {
...
Noble.prototype.onCharacteristicsDiscover = function(peripheralUuid, serviceUuid, characteristics) {
  ...
  if (service) {
    ...
    for (var i = 0; i < characteristics.length; i++) {
      ...
      if (typeof this._descriptors[peripheralUuid][serviceUuid][characteristicUuid] !== 'object') {
